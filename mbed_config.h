...
#define MBED_CONF_BG96_LIBRARY_BG96_GNSS_GALILEONMEATYPE                      0                                                                                                // set by library:bg96-library
#define MBED_CONF_BG96_LIBRARY_BG96_GNSS_GLONASSNMEATYPE                      0                                                                                                // set by library:bg96-library
#define MBED_CONF_BG96_LIBRARY_BG96_GNSS_GNSSCONFIG                           1                                                                                                // set by library:bg96-library
#define MBED_CONF_BG96_LIBRARY_BG96_GNSS_GPSNMEATYPE                          8                                                                                                // set by library:bg96-library
